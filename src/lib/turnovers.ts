...
const TRANSITIONS: Record<string, TurnoverStatus[]> = {
  ...
  SCHEDULED: ["ASSIGNED", "BLOCKED", "DRAFT", "OVERDUE"],
  ASSIGNED: ["IN_PROGRESS", "SCHEDULED", "BLOCKED", "OVERDUE"],
  IN_PROGRESS: ["READY_FOR_QA", "BLOCKED", "ASSIGNED", "OVERDUE"],
  READY_FOR_QA: ["COMPLETED", "NEEDS_REWORK", "IN_PROGRESS", "BLOCKED"],
  NEEDS_REWORK: ["IN_PROGRESS", "READY_FOR_QA", "ASSIGNED", "BLOCKED"],
  BLOCKED: ["DRAFT", "SCHEDULED", "ASSIGNED", "IN_PROGRESS"],
  OVERDUE: ["ASSIGNED", "IN_PROGRESS", "READY_FOR_QA", "BLOCKED", "COMPLETED"],
  COMPLETED: [],
};
